...
urlApiClick = 'https://arbuz.betty.games/api/click'
...
} # ДЛЯ ПРОШАРЕННЫХ. Для более лучшей безопасности (андетекта вас), измените хедеры user-agent, sentry-trace итп на ваши (допустим взяв из вашего смартфона)
